...
from CompanyProject.Fastbull.AppUI_fastbull.common.common import take_screenshot
from CompanyProject.Fastbull.AppUI_fastbull.data.load_testdata import load_data
