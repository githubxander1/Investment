...
def run_testcases_and_generate_report(test_script):
    # 使用pytest.main运行测试
...
if __name__ == '__main__':
    # 从命令行参数获取配置信息
    # test_script = 'test_stock_filters.py'
    test_script = 'test_login.py'

    allure_results_dir = '../result'
    allure_report_dir = './report_allure/'

    run_testcases_and_generate_report(test_script)
    # send_notifications()
    # run_server()
