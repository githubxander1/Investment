...
def sales_submit_merchant_info(page, email, merchant_id, pdf_file_path):
    ...
    scroll_width = scroll_div.query_selector('#scrollDivTable').evaluate('el => el.offsetWidth')
    scroll_div.evaluate(f'(el) => el.scrollLeft = {scroll_width}')
    ...
    with page.expect_popup() as popup_info:
        ...
        # page.get_by_text("Submit").nth(3).click()
