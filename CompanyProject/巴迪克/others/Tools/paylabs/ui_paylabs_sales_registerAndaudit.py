...
from CompanyProject.巴迪克.Tools.paylabs.ui_paylabs_merchant_register import paylabs_merchant_register
from CompanyProject.巴迪克.Tools.paylabs.GoogleSecure import CalGoogleCode
from CompanyProject.巴迪克.Tools.paylabs.perform_slider_unlock import perform_block_slider_verification
...
def sales_login(page , sales_login_name):
    ...
    paylabs_merchant_google_code = calculategooglecode.generate_google_code('192.168.0.233', 3306, 'paylabs_payapi', 'SharkZ@DBA666',
                                                        'logic', 'sales_operator', sales_login_name)
...
def platform_login(page ,paylabs_operator_login_name):
    ...
    calculategooglecode = CalGoogleCode()
    paylabs_platform_google_code = calculategooglecode.generate_google_code('192.168.0.233', 3306, 'paylabs_payapi', 'SharkZ@DBA666', 'logic', 'operator', paylabs_operator_login_name)
    page.pause()
...
def run(playwright: Playwright) -> None:
    ...
    paylabs_operator_login_name = 'Xander@sitch.logic.co.id'# 平台审核登录用户，可自定义
