...
def run(playwright: Playwright) -> None:
    ...
    # koalafirst 商户入口
    page.goto("http://koalafirst-test.com/merchant/koalafirst-register-register.html")
    page.get_by_role("link", name="中文").click()

    page.get_by_role("textbox", name="公司名称 *").fill("本地商户公司001")
    ...
    100印尼 101中国 105其他海外 106越南 107巴西 108泰国 109土耳其 110哥伦比亚 111印度 112孟加拉 '''
    ...
    1直播 2线上博弈 3外汇交易 4金融行业 5二元期货 6加密平台 7线上约会 8其他 9本地商户 10本地聚合支付 '''
    page.get_by_label("商户类型 *").select_option("9")
    ...
    '''国家：Indonesia,Vietnam,Brazil,Thailand,Turkey,Colombia,India,Bangladesh'''
