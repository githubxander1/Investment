...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("textbox", name="Nomor Ponsel").fill("15318544154")
    page.get_by_role("textbox", name="Kata Sandi").fill("Abc@123456789")
    ...
    page.get_by_role("textbox", name="Kode Verifikasi Google").fill(generate_google_code())
    ...
    page1.pause()
    # page1.locator("#btnUpload12").click()
    # page1.locator("#btnUpload12").set_input_files("合同.pdf")
    # page1.locator("#btnUpload13").click()
    # page1.locator("#btnUpload13").set_input_files("合同.pdf")
    # page1.locator("#btnUpload16").click()
    # page1.locator("#btnUpload16").set_input_files("合同.pdf")
    # page1.locator("#btnUpload18").click()
    # page1.locator("#btnUpload18").set_input_files("合同.pdf")
    # page1.locator("#btnUpload24").click()
    # page1.locator("#btnUpload24").set_input_files("合同.pdf")
    # page1.get_by_role("button", name="Upload").click()
    # page1.get_by_role("button", name="Upload").set_input_files("合同.pdf")
    page1.get_by_role("heading", name="").locator("i").click()
    page1.get_by_role("textbox", name="Business License").click()
    page1.get_by_role("treeitem", name="Final Articles of Association").click()
    page1.locator("#merFormModal i").click()
    page1.locator("#temps-modal").set_input_files("合同.pdf")
    ...
    page2.get_by_role("textbox", name="E-mail").click()
    page2.get_by_role("textbox", name="E-mail").click()
    page2.locator("span").filter(has_text="Bahasa").first.click()
    page2.get_by_role("link", name="English").click()
    page2.get_by_role("textbox", name="E-mail").click()
    page2.get_by_role("textbox", name="E-mail").fill("xzh@test.com")
    page2.get_by_role("textbox", name="Password Verification Code").click()
    page2.get_by_role("textbox", name="Password Verification Code").fill("Asd123456789.")
    page2.get_by_role("button", name=" Login").click()
    page2.get_by_role("button", name="Confirm").click()
    page2.get_by_role("textbox", name="Google Verification Code").click()
    page2.get_by_role("textbox", name="Google Verification Code").fill("849699")
    ...
    page2.get_by_role("gridcell", name="010387").click()
    ...
    page2.get_by_role("textbox", name="Max 200 characters can be").press("Home")
    page2.get_by_role("textbox", name="Max 200 characters can be").fill("风险审核通过")
    ...
    page2.get_by_role("textbox", name="Max 200 characters can be").click()
    page2.get_by_role("textbox", name="Max 200 characters can be").fill("风控审核通过111")
    page2.get_by_role("button", name="Comment").click()
...
def generate_google_code():
    ...
    secret_key = db_handler.get_google_secret_key('sales_operator', '15318544154')
    if secret_key:
