...
def run(playwright: Playwright) -> None:
    ...
    page2.locator("#rate232").click()
    page2.locator("#rate232").press("ArrowRight")
    page2.locator("#rate232").press("ArrowRight")
    page2.locator("#rate232").press("ArrowRight")
    page2.locator("#rate232").fill("0.0001")
    page2.locator("#transSharingRate232").click()
    page2.locator("#transSharingRate232").press("ArrowRight")
    page2.locator("#transSharingRate232").press("ArrowRight")
    page2.locator("#transSharingRate232").press("ArrowRight")
    ...
    page2.locator("#transSharingRate233").click()
    page2.locator("#transSharingRate233").press("ArrowRight")
    page2.locator("#transSharingRate233").press("ArrowRight")
    page2.locator("#transSharingRate233").press("ArrowRight")
    ...
    page2.locator("#transSharingRate1242").click()
    page2.locator("#transSharingRate1242").press("ArrowRight")
    page2.locator("#transSharingRate1242").press("ArrowRight")
    page2.locator("#transSharingRate1242").press("ArrowRight")
    ...
    page2.locator("#rate1231").click()
    page2.locator("#rate1231").press("ArrowRight")
    page2.locator("#rate1231").press("ArrowRight")
    page2.locator("#rate1231").press("ArrowRight")
    page2.locator("#rate1231").fill("0.0001")
    page2.locator("#transSharingRate1231").click()
    page2.locator("#transSharingRate1231").press("ArrowRight")
    page2.locator("#transSharingRate1231").press("ArrowRight")
    page2.locator("#transSharingRate1231").press("ArrowRight")
    page2.locator("#transSharingRate1231").press("ArrowRight")
    ...
    page2.locator("#rate1239").click()
    page2.locator("#rate1239").press("ArrowRight")
    page2.locator("#rate1239").press("ArrowRight")
    page2.locator("#rate1239").press("ArrowRight")
    page2.locator("#rate1239").fill("0.0001")
    page2.locator("#transSharingRate1239").click()
    page2.locator("#transSharingRate1239").press("ArrowRight")
    page2.locator("#transSharingRate1239").press("ArrowRight")
    page2.locator("#transSharingRate1239").press("ArrowRight")
    ...
    page2.locator("#transSharingRate1218").click()
    page2.locator("#transSharingRate1218").press("ArrowRight")
    page2.locator("#transSharingRate1218").press("ArrowRight")
    page2.locator("#transSharingRate1218").press("ArrowRight")
    ...
    page2.get_by_role("cell", name="*Merchant Fee % Sample:0.7000").get_by_role("textbox").first.click()
    page2.get_by_role("cell", name="*Merchant Fee % Sample:0.7000").get_by_role("textbox").first.click()
    page2.get_by_role("cell", name="*Merchant Fee % Sample:0.7000").get_by_role("textbox").first.fill("0.01")
    page2.get_by_role("textbox", name="1000").click()
