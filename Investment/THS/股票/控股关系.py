...
def get_stock_holding_relation():
    """
    该函数用于向指定接口发送请求，获取股票（代码为600188）的控股关系信息。
    """
    # 接口的URL地址，用于获取特定股票的控股关系数据，这里的600188就是对应股票的代码。
    url = "https://basic.10jqka.com.cn/basicapi/holder/stock/holding/relation?code=600188"
    # 请求头信息，包含了诸如浏览器标识、来源页面等多种信息，用于模拟正常的浏览器请求，使得服务器能够正确响应。
    headers = {
        "Host": "basic.10jqka.com.cn",
        "Connection": "keep-alive",
        "Accept": "application/json, text/plain, */*",
        "hexin-v": "A1JEZejCBu24151NuErUhERuqhM0Y1bxiGFKIRyrflbwb_2JBPOmDVj3mlnv",
    ...
    cookies = {
        ...
        "v": "A1JEZejCBu24151NuErUhERuqhM0Y1bxiGFKIRyrflbwb_2JBPOmDVj3mlnv"
    }
...
if __name__ == "__main__":
    # 调用函数来获取股票控股关系信息。
    result = get_stock_holding_relation()
    if result:
