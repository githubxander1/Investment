...
def get_company_base_info():
    """
    该函数用于向指定接口发送请求，获取公司的基本信息
    """
    # 接口的URL地址
    url = "https://basic.10jqka.com.cn/basicapi/company_info/merge_info/v1/base_info/"
    # 请求参数，包括股票代码、市场和类型
    params = {"code": "600188", "market": "17", "type": "stock"}
    # 请求头信息，模拟浏览器请求
    headers = {
    ...
    cookies = {
        ...
        "v": "A31rZGvboZwr_mIsXm5TdRfXhdJ3GrFsu04VQD_CuVQDdpIIB2rBPEueJQTM"
    }
