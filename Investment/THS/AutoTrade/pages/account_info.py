...
if __name__ == '__main__':
    ...
    #     print(f"账户总资产: {account_asset}")
    #     print(f"账户余额: {account_balance}")
    #     print(f"股票可用数量: {stock_available}")
    #     print(f"持仓比例: {stock_ratio}")
    #     print(f"股票当前价: {stock_price}")

    # account.update_holding_info_for_account('中泰证券')
