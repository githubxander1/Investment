...
from Investment.THS.AutoTrade.config.settings import (
    ...
    Strategy_portfolio_today, Combination_portfolio_today, Combination_holding_file,
...
async def auto_main():
    ...
    if check_files_modified(file_paths, last_modification_times):
        process_excel_files(ths_page, file_paths, operation_history_file, holding_stock_file=Combination_holding_file)
        logger.info("文件处理完成")
