...
# 修改导入，使用新的读写函数
from Investment.THS.AutoTrade.scripts.data_process2 import read_portfolio_or_operation_data, write_to_excel_append,read_today_portfolio_record,save_to_operation_history_excel
