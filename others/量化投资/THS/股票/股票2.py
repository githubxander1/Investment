...
def get_stock_report_data():
    """
    该函数用于向指定接口发送请求，获取股票（代码为600188）的报告数据。
    """
    # 接口的URL地址，用于获取特定股票的报告数据，这里的17表示市场代码，600188是股票代码
    url = "https://basic.10jqka.com.cn/basicapi/report/data/17/600188/"
