# z_others.测试相关.ApiTest_mindmaster.api_mind.logic.logic.py
import json
import os
...
# api_data = read_yaml(r'D:\1document\1test\PycharmProject_gitee\z_others\测试相关\api_mind\config\Api.yaml')["login"]
# pprint(api_data)
