...
?>" name="search_form" method=post >
		...
		<ul class="search_hot_keyword">
			<?php $_from = $this->_var['hot_kw']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'kw_0_79026600_1484810744');if (count($_from)):
    foreach ($_from AS $this->_var['kw_0_79026600_1484810744']):
?>
			<li><a href="<?php echo $this->_var['kw_0_79026600_1484810744']['url']; ?>"><?php echo $this->_var['kw_0_79026600_1484810744']['txt']; ?></a></li>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		</ul>
	</div>
</div><!--logo与头部搜索-->
