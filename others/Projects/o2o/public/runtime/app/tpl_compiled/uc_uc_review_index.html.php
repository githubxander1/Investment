...
$this->_var['pagecss'][] = $this->_var['TMPL_REAL']."/css/uc_review.css";
...
$this->_var['pagejs'][] = $this->_var['TMPL_REAL']."/js/page_js/uc/uc_review.js";
$this->_var['cpagejs'][] = $this->_var['TMPL_REAL']."/js/page_js/uc/uc_review.js";
?>
...
?> clearfix">
	...
	<div class="right_box">
		...
		<div class="main_box">
			<div class="content">
				<div class="title"><span>我的点评</span></div>
				<div class="blank20"></div>
				<div id="review_list">
