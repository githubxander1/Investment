...
$this->_var['pagejs'][] = $this->_var['TMPL_REAL']."/js/review.js";
$this->_var['cpagejs'][] = $this->_var['TMPL_REAL']."/js/review.js";
?>
...
<div class="page wrap_full">
	...
	<div class="right_box">
		<div class="content">
			...
			<div class="form_box">
				<form name="review_form" action="<?php echo $this->_var['form_url']; ?>" method="post">
					<?php echo $this->fetch('pages/review/review_list_box.html'); ?>
				</form>
			</div>
		</div>
	</div>	
