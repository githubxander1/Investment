...
?>" lazy="true"/>
									...
									<?php endif; ?>
									<?php if ($this->_var['MODULE_NAME'] == 'goods' || $this->_var['MODULE_NAME'] == 'deal'): ?>
									<?php if(defined("FX_LEVEL")){?>
									<li style="border:none;width:200px;font-weight:bold;">该商品被<?php echo $this->_var['row']['fx_count']; ?>人代理</li>
									<?php }?>
									<?php endif; ?>
								</div>
							</td>
