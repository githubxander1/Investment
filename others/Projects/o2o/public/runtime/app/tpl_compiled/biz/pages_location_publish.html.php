...
echo parse_url_tag("u:biz|location#index|"."".""); 
						...
						<table class="form_teble_box add_border">
									...
									<tbody>
										...
										<tr>
											...
											<td class="t_field_value"><input class="ui-textbox long_input" name="tags" value=""/>&nbsp;<span class="t_tip">[多个标签以空格分隔]</span></td>
										</tr>
										<tr>
											...
											<td class="t_field_value">
												...
												<div class="preview_upload_box pub_upload_img_box"></div>
											</td>
										</tr>
										<tr>
											...
											<td class="t_field_value">
												...
												<div class="location_images_upload_box pub_upload_img_box"></div>
											</td>
										</tr>
										<tr>
...
?>
										...
										<tr>
											...
											<td class="t_field_value"><input class="ui-textbox long_input" name="address" value=""/></td>
										</tr>	
										<tr>
											<td class="t_field_name">交通路线:</td>
											<td class="t_field_value">
												<textarea id="description" name="route" class="t_textarea"></textarea>
											</td>
										</tr>
										<tr>
											<td class="t_field_name ">联系电话:</td>
											<td class="t_field_value"><input class="ui-textbox long_input" name="tel" value=""/></td>
										</tr>
										<tr>
											<td class="t_field_name ">联系人:</td>
											<td class="t_field_value"><input class="ui-textbox long_input" name="contact" value=""/></td>
										</tr>	
										<tr>
											<td class="t_field_name ">营业时间:</td>
											<td class="t_field_value"><input class="ui-textbox long_input" name="open_time" value=""/></td>
										</tr>	
										<tr class="biz_map">
									            <td class="t_field_name">地图定位</td>
									            <td class="t_field_value">            	
									            	<span class="f_l map_search_label">地图关键词：</span><input type="text" class="ui-textbox map_keyword f_l" name="api_address" value="" /> 
