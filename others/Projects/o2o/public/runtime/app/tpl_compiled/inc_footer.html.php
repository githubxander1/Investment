...
?>
	...
	<div class="friend_link">
		<ul>
			<?php $_from = $this->_var['links']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'link_0_02068300_1484810745');if (count($_from)):
    foreach ($_from AS $this->_var['link_0_02068300_1484810745']):
?>
			<li><a href="http://<?php echo $this->_var['link_0_02068300_1484810745']['url']; ?>" target="_blank" title="<?php echo $this->_var['link_0_02068300_1484810745']['name']; ?>"><?php if ($this->_var['link_0_02068300_1484810745']['img']): ?><img lazy="true" src="<?php 
$k = array (
  'name' => 'get_spec_image',
  'v' => $this->_var['link_0_02068300_1484810745']['img'],
  'w' => '100',
  'h' => '36',
  'g' => '1',
);
echo $k['name']($k['v'],$k['w'],$k['h'],$k['g']);
?>" /><?php else: ?><?php echo $this->_var['link_0_02068300_1484810745']['name']; ?><?php endif; ?></a></li>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		</ul>
	</div><!--friend_link-->
	<div class="blank"></div>
