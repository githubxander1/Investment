...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(18).39(4(){2R();2v();2C();3($("#A").13>0)2p();2Q();2A();2D();3b()});2 1x=b;4 2p(){$.2d=4(n){$("#A").8(".37 a").j("m",4(){2 2z=$(f).c("3c");$("#A").d("<Z 1G=\'2V\'></Z>");1x=h;$.2f({2g:2z,1I:n,1F:"1K",1L:"21",2W:b,1V:4(G){$("#A").d(G.d);$.2d(n)}});2N b})};$.1r=4(){2 2s=$(T).z();2 2j=$("#A").1l().r;2 2F=$(T).25();3(!1x){3(2F+2s>=2j){2 n=2b 30();n.1h=$("#A").c("1h");n.2M=$("#A").c("2M");n.35=$("#A").c("35");n.2T="1r";$("#A").d("<Z 1G=\'2V\'></Z>");1x=h;$.2f({2g:2S,1I:n,1F:"1K",1L:"21",2W:b,1V:4(G){$("#A").d(G.d);$.2d(n)}})}}};$.1r();$(T).j("1R",4(e){$.1r()})}4 2R(){$("#1c").8("a").j("m",4(){3($(f).c("1G")=="g")2N;2 1w=$(f).8("1w");$("#1c").8("a").q("g");$(f).s("g");$("#1N").c("2I",$(1w).c("2I"));$("#1N").3g({38:3e,3d:$(1w).c("1N"),36:h})});$(".Y").3a(4(){$(f).8(".1b").H({1t:0},{M:X,L:b});$(f).8(".1d").H({2l:0},{M:X,L:b})},4(){$(f).8(".1b").H({1t:-29},{M:X,L:b});$(f).8(".1d").H({2l:-29},{M:X,L:b})});2 1S=$("#1c").8("a").13;2 B=0;2 3f=1Y;$(".Y").8(".1b").s("S");$(".Y").8(".1b").j("m",4(){3(B>0){B--;$(".Y").8(".1d").q("S");3(B==0){$(f).s("S")}9{$(f).q("S")}}$("#1c").H({1t:0-1Y*B},{M:X,L:b})});$(".Y").8(".1d").j("m",4(){3(B<1S-5){B++;$(".Y").8(".1b").q("S");3(B==1S-5){$(f).s("S")}9{$(f).q("S")}}$("#1c").H({1t:0-1Y*B},{M:X,L:b})})}4 2v(){2 1C=$("#V").c("1C");2 1j=$("#V").c("1j");2 1J=2o;$.1T=4(1Q){2 2B=$(1Q).c("3h");2 Q="";2 W=(F(1C)-F(1j))/2o;3(W>=0){2 2w=1z.1p(W%1H);2 2E=1z.1p((W/1H)%1H); 2 2t=1z.1p((W/2h)%24); 2 1U=1z.1p((W/2h)/24);3(1U>0)Q="<K>"+1U+"</K>天";Q=Q+"<K>"+2t+"</K>时<K>"+2E+"</K>分"+"<K>"+2w+"</K>秒";Q=2B+Q;$(1Q).d(Q);1j=F(1j)+1J}9{$("#V").3I()}};$.1T($("#V"));$("#V").3J(1J,4(){$.1T($("#V"))})}4 2C(){$.33=4(){2 t=h;2 p=[];$("#1a .1f").1y(4(i,o){3($(o).c("1g")){p.2a($(o).8("a[g=\'h\']").c("x"))}9{t=b}});2 1k=1h;2 1u=$("#u").v();3(t)2U(1k,1u,p)};$.14=4(7){3(7==1){$(".11 .20").s("1A")}9{$(".11 .20").q("1A")}3(7>=U){$(".11 .1D").s("1A")}9{$(".11 .1D").q("1A")}};3(D==0){$("#u").v(1);$.14(1)}9{$("#u").v(D);$.14(D)}$.17=4(){2 t=h;2 J=h;2 16=3K;2 1v=1e;2 2r=3H;2 P=-1;2 p=2b 3G();$("#1a .1f").1y(4(i,o){$(o).8("a").q("g");3($(o).c("1g")){$(o).8("a[g=\'h\']").s("g");1v+=3D($(o).8("a[g=\'h\']").c("3E"));p.2a($(o).8("a[g=\'h\']").c("x"))}9{t=b}});p=p.3F();2m=p.3M("3L");3($("#1a .1f").13>0){2 R=2q[2m];3(R){2r=R[\'3P\'];16=R[\'2G\']}9{2 1P=b;2i(2 k=0;k<p.13;k++){2 2n=p[k];R=2q[2n];3(R){16=R[\'2G\'];1P=h;2u}}3(!1P)16=-1}}3(16>=0){P=16}3(P>=0){$("#1O").8("Z").E();$("#1O").8(".3O").d(P)}9{$("#1O").8("Z").2c()}2 7=F($("#u").v());3(P>=0){3(P<D){J=b;$("#I").d("每单最少购买"+D+"份,库存不足")}9 3(7>P){J=b;$("#I").d("库存不足")}9 3(7<D){J=b;$("#I").d("每单最少购买"+D+"份")}9 3(12>0&&7>12){J=b;$("#I").d("每单最多购买"+12+"份")}9{$("#I").d("")}}9{3(7<D){J=b;$("#I").d("每单最少购买"+D+"份")}9 3(12>0&&7>12){J=b;$("#I").d("每单最多购买"+12+"份")}9{$("#I").d("")}}2 10=$("#10");2 O=10.1d();3(t&&J){3(1Z!=1)$("#1e").d(1v);O.c("x","1X");O.q("1M");O.s("1X");10.2K("m");10.j("m",4(){$.33()})}9{3(t){3(1Z!=1)$("#1e").d(1v)}9{3(1Z!=1)$("#1e").d(1e)}O.c("x","1M");O.q("1X");O.s("1M");10.2K("m")}};$.17();$("#1a .1f").1y(4(i,o){t=b;$(o).8("a").j("m",4(){2 1W=$(f);2 2H=1W.c("g");$(o).8("a").2J("g");$(o).2J("1g");3(!2H){1W.c("g",h);$(o).c("1g",h)}$.17()})});$("#u").j("3C",4(){2 7=$(f).v();3(1E(7)||F(7)<=0)7=1;3(7>U)7=U;$.14(7);$(f).v(7);$.17()});$("#u").j("3o",4(){$(f).3p()});$(".11 .20").j("m",4(){2 7=$("#u").v();7=F(7)-1;3(1E(7)||F(7)<=0)7=1;3(7>U)7=U;$.14(7);$("#u").v(7);$.17()});$(".11 .1D").j("m",4(){2 7=$("#u").v();7=F(7)+1;3(1E(7)||F(7)<=0)7=1;3(7>U)7=U;$.14(7);$("#u").v(7);$.17()})}4 2Q(){$("#3q").j("m",4(){2 t=h;2 p=[];$("#1a .1f").1y(4(i,o){3($(o).c("1g")){p.2a($(o).8("a[g=\'h\']").c("x"))}9{t=b}});2 1k=1h;2 1u=$("#u").v();3(t)2U(1k,1u,p);9 $.31("请选择商品规格")});2 1i=b;2 19=-1;$.26=4(){3($.y.1n&&$.y.1o=="6.0"){$(".w-l").C("r",$(18).z())}2 27=$("#23").1l().r;2 2O=$(18).z();3(2O>27){3(!1i){1i=h;$(".w-l").E();$("#23").C("2L","3n");3($.y.1n&&$.y.1o=="6.0"){$(".w-l").C("1s",3m)}9{$(".w-l").C({"r":0,"2X":"3j"});$(".w-l").H({1s:3k},{M:2Z,L:b})}}}9{3(1i){1i=b;$("#23").C("2L","3l");3($.y.1n&&$.y.1o=="6.0"){$(".w-l").2c();$(".w-l").C("1s",2Y)}9{$(".w-l").C({"r":27,"2X":"3r"});$(".w-l").H({1s:2Y},{M:2Z,L:b,3s:4(){$(".w-l").2c()}})}}}2 15=$(".E-2x .1q");$(".E-l").8("1m").q("g");19=-1;2i(i=0;i<15.13;i++){2 z=$(18).z()+3y;2 28=$(15[i]).1l().r;2 22=28+3z;3(i<15.13-1)22=$(15[i+1]).1l().r;3(z>=28&&z<22){2 N=$(15[i]).c("x");19=N;2u}}$(".E-l").8("1m[x=\'"+19+"\']").s("g")};$.26();$(T).1R(4(){$.26()});$.2e=4(2y){2 N=2y;2 1q=$(".E-2x .1q[x=\'"+N+"\']");2 r=$(1q).1l().r-3x;$("d,3t").H({z:r},"3u","3v",4(){19=N;$(".E-l").8("1m").q("g");$(".E-l").8("1m[x=\'"+19+"\']").s("g")})};$(".E-l").8("1m").j("m",4(){2 N=$(f).c("x");$.2e(N)});$("#3w").j("m",4(){$.2e(\'3A\')})}4 2A(){$.1B=4(){2 n=2b 30();n.1k=1h;n.2T="1B";$.2f({2g:2S,1I:n,1F:"1K",1L:"21",1V:4(G){3(G.34==1){$.3B(G.32)}9 3(G.34==-1){3Q()}9{$.31(G.32)}},3i:4(3N){}})};$("#1B").j("m",4(){$.1B()})}4 2D(){$(T).1R(4(){3($.y.1n&&$.y.1o=="6.0"){$("#2k").C("r",$(18).z()+$(T).25()-2P)}});3($.y.1n&&$.y.1o=="6.0")$("#2k").C("r",$(18).z()+$(T).25()-2P)}',62,239,'||var|if|function|||buy_num|find|else||false|attr|html||this|active|true||bind||nav|click|query||attr_checked_ids|removeClass|top|addClass|is_choose_all|deal_num|val|fix|rel|browser|scrollTop|supplier_deal|current_idx|css|deal_user_min_bought|show|parseInt|obj|animate|stock_tips|is_stock|span|queue|duration|rel_id|buy_btn_ui|deal_remain_stock|timeHtml|attr_spec_stock_cfg|disable_tag|window|9999|countdown|sysSecond|100|pic_hidden|div|buy_btn|num_choose|deal_user_max_bought|length|init_buy_num_ui|content_boxes|stock|init_buy_ui|document|content_idx|main_package_choose|pre|small_pic|next|deal_price|package_choose|is_choose|deal_id|is_show_fix|nowtime|id|offset|li|msie|version|floor|content_box|load_supplier_deal|width|left|number|deal_show_price|img|is_load_supplier_deal|each|Math|num_choose_disabled|add_collect|endtime|increase|isNaN|dataType|class|60|data|timespan|json|type|disabled|big_pic|stock_span|has_stock_attr|dom|scroll|img_total|show_countdown|day|success|spec_btn|orange|94|buy_type|less|post|next_top|rel_nav||height|reset_nav|navheight|current_top||push|new|hide|bind_supplier_deal_pager|scroll_to|ajax|url|3600|for|loadheight|s_kf_qq|right|attr_checked_ids_str|key|1000|init_load_supplier_deal|deal_attr_stock_json|deal_show_buy_count|scrolltop|hour|break|init_countdown|second|content|idx|ajax_url|collect_deal|showTitle|init_buy_choose|init_kf_qq|minite|windheight|stock_cfg|is_active|origin|removeAttr|unbind|visibility|supplier_id|return|docheight|80|init_content_nav|init_gallary|AJAX_URL|act|add_cart|loading|global|position|750|200|Object|showErr|info|buy_action|status|supplier_name|refresh|pages|placeholder|ready|hover|app_download|href|src|LOADER_IMG|width_unit|ui_lazy|showtitle|error|fixed|990|visible|900|hidden|focus|select|flow_btn|absolute|complete|body|fast|swing|show_store|40|50|50000|n0|showSuccess|blur|parseFloat|price|sort|Array|deal_buy_count|stopTime|everyTime|deal_stock|_|join|ajaxobj|inventory|buy_count|ajax_login'.split('|'),0,{}))
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(30).31(5(){1b()});4 1W=8;4 1q=d;5 1b(){$.1b=5(){4 g=2F 2M();g.1S=$("#13").6("1S");g.2f=$("#13").6("2f");g.2c=$("#13").6("2c");g.2D="1b";$("#13").t("<z D=\'2W\'></z>");$.2G({1F:2L,2K:g,2J:"2I",l:"2g",2z:8,2o:5(G){$("#13").t(G.t);1W=d;21();1c()}})};$.1b()}5 21(){1z();24();32();2d();$(".33-38-w .p-2V").1x(5(){$(9).1y("1i")},5(){$(9).1A("1i")});$(\'#36\').H(\'m\',5(){2C()})}4 r=0;5 24(){4 E=2t;4 w=$("#A  1E");4 1l=$(w).c("1n").Z;4 1a=1Y.25(1l/3);4 23=0-r*E;$(w).34({"14":1a*E,"s":23});$(w).c("1n").W(5(i,o){$(o).6("29",i)});$("#A 1E.1X 1n").1x(5(){$(9).1y("1i")},5(){$(9).1A("1i")});$("#A").1x(5(){$("#A").39();$(9).c(".1O").X({s:0},{J:1s,17:8});$(9).c(".1J").X({1Z:0},{J:1s,17:8})},5(){$(9).c(".1O").X({s:-22},{J:1s,17:8});$(9).c(".1J").X({1Z:-22},{J:1s,17:8})});$("#A").c(".1O").H("m",5(){r--;7(r<0)r=1a-1;1H(r,"#A",E)});$("#A").c(".1J").H("m",5(){r++;7(r>=1a)r=0;1H(r,"#A",E)})}5 1H(26,20,E){4 w=$(20+" 1E.1X");4 1l=$(w).c("1n").Z;4 1a=1Y.25(1l/3);4 s=0-26*E;$(w).X({s:s},{"J":3v})}5 2d(){$(\'L[l="x"][y="Y"]\').1d().3u("m");$(\'L[l="x"][y="Y"]\').1d().H(\'m\',5(e){4 k=$(9).c(\'L[l="x"][y="Y"]\');4 f=11($(k).Q());4 1B=M[f];4 15=1C[f];7(!1B){v 8}7(!15){4 1e=11(1B[\'1e\']);7((1e!=-1)&&(1e<=0)){$.S(\'该产品库存不足，无法购买\');v 8}7($(k).6("q")){$(k).6("q",8)}n{$(k).6("q",d)}$(9).1M({1Q:d});1c();v 8}n{7($(k).6("q")){$(k).1d().c(\'2p\').t("&2m;"+K(M[f][\'1N\']).1t(2));$(k).6("q",8);$(9).1M({1Q:d});1c();v 8}4 P=\'<z D="1V 2e">\';1h(4 j 2a 15){P+=\'<z D="1p 2b " j="\'+j+\'">\'+\'<16 D="3a 3s">\'+j+\'</16>\'+\'<z D="3x 2e 2b 3A" 28="14:3y;">\';1h(4 i 2a 15[j]){P+=\'<a 2A="3p:3f(0);" N="\'+f+\'" h="\'+i+\'">\'+15[j][i][\'3g\']+\'<i D="3b">&#3c;</i>\'+\'</a>\'}P+=\'</z>\'+\'</z>\'}P+=\'<27 /><27 /><16 y="C" 28="3h:3i;">库存：0</16><18 D="3n-18 3m" f="2B" 29="3l">保存规格</18></z>\';$.1D.2l(P,{2h:\'10\',2j:\'2q\',l:\'2x\',2w:8,2u:"选择规格",14:3j});$("#10 .1p").W(5(i,o){3k=8;$(o).c("a").H("m",5(){4 1w=$(9);4 1U=1w.6("u");$(o).c("a").1T("u");$(o).1T("F");7(!1U){1w.6("u",d);$(o).6("F",d)}4 1k=d;4 1P=[];4 B=[];$("#10 .1p").W(5(3o,T){$(T).c("a").1A("u");7($(T).6("F")){$(T).c("a[u=\'d\']").1y("u");B.I($(T).c("a[u=\'d\']").6("h"));1P.I($(T).6("j"))}n{1k=8}});4 1r=$("#10 .1V").c(\'16[y="C"]\');4 3e=1k?d:8;4 1g=8;4 C=-1;1q=d;7(1k){1h(4 O=0;O<1P.Z;O++){7(12[f][B[O]]&&11(12[f][B[O]][\'1K\'])>=0){C=12[f][B[O]][\'1K\'];1g=d}n{B.3z(5(a,b){v a>b?1:-1});7(12[f][B.1o("V")]){C=11(12[f][B.1o("V")][\'1K\']);1g=d}}}}7(C==0){1q=8}7(1g&&C!=-1){1r.t("库存："+C);1r.3r()}n{1r.3t()}})});1z();$(\'#2B\').m(5(){2v(k)})}})}5 2C(){4 g=2F 2M();g[\'3q\']=1S;g[\'f\']=[];g[\'1R\']=[];$(\'L[l="x"][y="Y"]:x:q\').W(5(i,o){g[\'f\'].I($(9).Q());4 h=$(9).6(\'h\');7(!h){g[\'1R\'].I(\'0\')}n{g[\'1R\'].I(h)}});7($("#2H:q").Z==0){$.S(\'搭配主项必需选择\');v 8}7(g[\'f\'].Z<=0){$.S(\'请选择要购买的商品\');v 8}g.2D="3d";$.2G({1F:2L,2K:g,2J:"2I",l:"2g",2z:8,2o:5(G){7(G.2i==1){$.1D.2l(G.t,{2h:\'19\',2j:\'2q\',2w:8,2u:"购物提示",14:2t,l:\'2x\',3B:5(){1z();$("#19").c("18[1G=\'1L\']").H("m",5(){4 1j=$("#2k .2n").2E().1j;4 s=$("#2k .2n").2E().s;$("#19").X({14:0,3C:0,s:s,1j:1j,3w:0},{J:37,17:8,2N:5(){$.1D.1L("19")}})});$("#19").c("18[1G=\'2O\']").H("m",5(){2U.2A=$(9).6("1G-1F")})},2R:5(){2Q()}})}n 7(G.2i==-1){2P()}n{$.S(G.2T)}}})}5 2v(k){4 F=d;4 1I=[];4 R=[];4 N=0;$("#10 .1p").W(5(i,o){7(!$(o).6("F")){F=8}n{7(!N){N=11($(o).c("a[u=\'d\']").6("N"))}h=$(o).c("a[u=\'d\']").6("h");1I.I(h);R.I($(o).6(\'j\'))}});7(!F){$.S(\'请选择规格\');v 8}7(!1q){$.S(\'库存不足\');v 8}4 1u=$(\'L[l="x"][y="Y"][2s="\'+N+\'"]\');1u.6("q",d);1u.6("h",1I.1o(\'V\'));1u.6("j",R.1o(\'V\'));$(k).6("q",d);$(k).1d().1M({1Q:d});1c();$(".2S-1L").m()}5 1c(){4 U=0;4 1m=0;4 1v=0;$(\'L[l="x"][y="Y"]:x:q\').W(5(i,o){4 f=$(9).6(\'2s\');4 h=$(9).6(\'h\');4 j=$(9).6(\'j\');7(h&&j){U+=K(M[$(9).Q()][\'1N\']);1m+=K(M[$(9).Q()][\'2y\']);4 1f=h.2r(\'V\');4 R=j.2r(\'V\');1h(4 i=0;i<1f.Z;i++){7(1C[f][R[i]][1f[i]]){U+=K(1C[f][R[i]][1f[i]][\'35\'])}}$(9).1d().c(\'2p\').t("&2m;"+U.1t(2))}n{U+=K(M[$(9).Q()][\'1N\']);1m+=K(M[$(9).Q()][\'2y\'])}7($(9).6("f")!="2H")1v++});$(\'#2X\').t(1v);$(\'#2Y\').t("￥"+U.1t(2));$(\'#2Z\').t(1m.1t(2))}',62,225,'||||var|function|attr|if|false|this|||find|true||id|query|id_1||key|cbo|type|click|else|||checked|relate_idx|left|html|active|return|box|checkbox|name|div|relate_content|attr_id|stock|class|item_width|is_choose|obj|bind|push|duration|parseFloat|input|jsonDeal|dealid|kk|popDiv|val|keyArr|showErr|o1|currP|_|each|animate|relateCheckbox|length|alertAttrBox|parseInt|jsonStock|relate_goods|width|attrItem|span|queue|button|fanwe_cart_box|spanCount|load_relate_goods|totalPrice|parent|max_bought|id_1Arr|is_show_sobj|for|current|top|isAllChoose|count|origP|li|join|package_choose|stock_is_ok|sobj|100|toFixed|cbObj|num|spec_btn|hover|addClass|init_ui_button|removeClass|item|jsonAttr|weeboxs|ul|url|action|roll_span|attr_idArr|t_right|stock_cfg|close|ui_checkbox|current_price|t_left|attr_key|refresh|attr_1|deal_id|removeAttr|is_active|component_rigth|is_load_relate_goods|roll|Math|right|box_id|initRelateGoodUi|40|offset_left|init_relate_roll|ceil|idx|br|style|rel|in|clearfix|supplier_name|initCheckPrice|f_r|supplier_id|post|boxid|status|contentType|cart_tip|open|yen|cart_count|success|strong|text|split|value|570|title|saveAttr|showButton|wee|origin_price|global|href|save_attr_btn|relateBuy|act|offset|new|ajax|main_goods|json|dataType|data|AJAX_URL|Object|complete|checkout|ajax_login|init_cart_tip|onclose|dialog|info|location|img|loading|relateCheckNum|relateCheckCurrPrice|relateCheckOrigPrice|document|ready|init_ui_checkbox|main|css|price|relate_buy_btn|300|good|stopTime|info_title|iconfont|xe620|relate_add_cart|is_checked|void|name_1|display|none|400|is_choose_all|white|flow_btn|ui|i1|javascript|mainId|show|f_l|hide|unbind|200|opacity|choose|250px|sort|active_parent|onopen|height'.split('|'),0,{}))
