...
eval(function(p,a,c,k,e,d){e=function(c){return c};if(!''.replace(/^/,String)){while(c--){d[c]=k[c]||c}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(2).1(0(){3("4",6,"5%",7)});',8,8,'function|ready|document|load_ofc|data_chart|100|ofc_data_url|350'.split('|'),0,{}))
