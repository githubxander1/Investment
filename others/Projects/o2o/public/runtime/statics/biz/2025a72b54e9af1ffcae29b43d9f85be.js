...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(A).z(2(){$(".m").i("l",2(){5 4=$(h).j("k");$.g("确定同意退款操作吗？",2(){5 3=f c();3.d="m";3.4=4;$.s({u:v,n:3,y:"x",w:"t",o:2(1){8(1.7==p){9.6()}a 8(1.7==0){$.q(1.b)}a{$.r(1.b,2(){9.6()})}}})})});$(".e").i("l",2(){5 4=$(h).j("k");$.g("确定拒绝退款操作吗？",2(){5 3=f c();3.d="e";3.4=4;$.s({u:v,n:3,y:"x",w:"t",o:2(1){8(1.7==p){9.6()}a 8(1.7==0){$.q(1.b)}a{$.r(1.b,2(){9.6()})}}})})})});',37,37,'|obj|function|query|id|var|reload|status|if|location|else|info|Object|act|do_refuse_coupon|new|showConfirm|this|bind|attr|rel|click|do_refund_coupon|data|success|1000|showErr|showSuccess|ajax|POST|url|AJAX_URL|type|json|dataType|ready|document'.split('|'),0,{}))
