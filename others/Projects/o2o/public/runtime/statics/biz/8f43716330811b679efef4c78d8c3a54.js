...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(8(){$("2.c").p("o",8(){4 0=$(a).q("7-0");4 g=$(a).r();4 5=n t();5.m="h";5.0=0;$.i({j:l,b:"k",7:5,G:"u",C:8(3){d(3.E==1){4 6=\'\';d(3.9==1){6="恢复营业"}f{6="暂停营业"}4 e=\'<2 A="w-2 c" x="y" b="2" 7-0="\'+0+\'" 9="\'+3.9+\'">\'+6+\'</2>\';$(g).v(e);s()}f{$.F(3.z)}D B}})})});',43,43,'id||button|result|var|query|txt|data|function|is_close|this|type|is_close_btn|if|btn_html|else|obj|set_is_close|ajax|url|POST|ajax_url|act|new|click|live|attr|parent|init_ui_button|Object|json|html|ui|rel|white|info|class|false|success|return|status|showErr|dataType'.split('|'),0,{}))
