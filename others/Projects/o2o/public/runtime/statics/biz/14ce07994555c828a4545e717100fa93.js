...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(5(){$("8[7=\'i\']").v(5(){2 8=$("8[7=\'i\']");2 4=$.u($("s[7=\'4\']").f());2 a=$("x[7=\'a\']").f();b(4.y==0){$.c("请输入优惠券序列号");e d}2 h=$(8).t();2 9=$(8).w("D");$.k({9:9,l:"g",j:h,n:"r",q:5(3){b(3.p==1){$.z("是否确定使用该优惠券",5(){2 6=G E();6.A="B";6.4=4;6.a=a;$.k({9:C,l:"g",j:6,n:"r",q:5(3){b(3.p==1){$.F("优惠券验证成功");$("s[7=\'4\']").f("")}o{$.c(3.m)}}})})}o{$.c(3.m)}e d}});e d})});',43,43,'||var|result|youhui_sn|function|query2|name|form|url|location_id|if|showErr|false|return|val|POST|query|youhui_form|data|ajax|type|msg|dataType|else|status|success|json|input|serialize|trim|submit|attr|select|length|showConfirm|act|use_youhui|ajax_url|action|Object|showSuccess|new'.split('|'),0,{}))
