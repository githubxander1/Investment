...
<div class="main">
<div class="main_title"><?php echo ($user_info["user_name"]); ?> <?php echo L("USER_MONEY");?>:<?php echo (format_price($user_info["money"])); ?>  <?php echo L("USER_SCORE");?>:<?php echo (format_score($user_info["score"])); ?>  经验:<?php echo ($user_info["point"]); ?></div>
