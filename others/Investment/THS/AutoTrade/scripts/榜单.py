...
from others.Investment.THS.AutoTrade.config.settings import Combination_headers, Combination_list_file
from others.Investment.THS.AutoTrade.scripts.组合.组合_榜单排行榜数据 import extract_data
