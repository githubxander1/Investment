...
class Demo(unittest.TestCase):
    ...
    @data([
        ...
        [{'email': "695418206@qq.com", 'from': "web", 'product': "master-online",
          'pw': "f2d8ddfc169a0ee6f8b0ecd924b1d300"}, "fail"],
        [{'email': "95418206@qq.com", 'from': "web", 'product': "master-online",
          'pw': "f2d8ddfc169a0ee6f8b0ecd924b1d300"}, "fail"]
    )
    ...
    def test_01(self, value, pre):  # 步骤5
