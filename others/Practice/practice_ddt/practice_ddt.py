...
#
# import unittest
# from ddt import ddt, testdata, unpack, file_data
#
# # ddt类装饰器++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# @ddt
...
#     # @testdata(实例25_批量生成PPT版荣誉证书,2,dataInExcel)
...
#
# # 列表
# #     @testdata([{'name':'peter','age':18},{'name':'tom','age':21}])
...
#     # 7 8
# # # 多个列表字典，拆分
# #     @testdata([{'name':'peter','age':12,'addr':'chang'},
...
#     @testdata({'name':'jack','age':31})
#     @unpack
#     def test06(self,name,age):
#         print(name,age)
#
#     # # 多个字典, 拆分
#     @testdata({'name':'peter','age':11},
#           {'name':'tom','age':23},
#           {'name':'jim','age':32})
#     @unpack
...
#     unittest.main()
#
# # from ddt import testdata, unpack, ddt
# # import unittest
# # #
...
# #     @testdata(test_data)       # 调用ddt的数据
# #     def test_add(self, a):
# #         print(a)
# #
# # """元组、列表数据驱动"""
# # import unittest
# # from ddt import ddt, testdata, unpack
# #
...
# # from ddt import ddt, testdata, unpack
# #
# # case_data = [{"url": "www.baidu.com", "testdata": "test_logs"},
# #              {"url": "www.baidu.com", "testdata": "test2"},
# #              {"url": "www.baidu.com", "testdata": "test3"}]
# #
# #
# # @ddt
...
#     # 第一种:不加unpack，直接传字典
#     @testdata({'email': "2695418206@qq.com", 'from': "web", 'product': "master-online",
#            'pw': "f2d8ddfc169a0ee6f8b0ecd924b1d300"},
#           )
#     def test_01(self, value):
#         url = 'https://userapi.edrawsoft.cn/api/user/login'
#         re = requests.post(url=url, testdata=value)
#         print(re)
#
