...
if __name__ == "__main__":
    # 指定要列出的目录路径
    directory_path = r'D:\1document\1test\PycharmProject_gitee\others\Projects\rili'
    # directory_path = r'D:\1document\1test\PycharmProject_gitee\zothers\Projects\schedule'
    # exclude_list = [
